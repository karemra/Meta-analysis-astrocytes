...
## The argument N is used to define the number of genes each study was able to profile (previously defined vector count)
rankmat <- rankMatrix(meta, N = count) 

##Run RRA analysis using the “aggregateRanks” command to obtain a significance score, 
##which identifies genes ranked consistently higher than expected by chance
...
##frame results, which consists of data about only those genes with adjusted p-value < 0.05
